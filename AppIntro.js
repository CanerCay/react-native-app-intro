...
export default class AppIntro extends Component {
    constructor(props) {
        ...
        this.parallax = new Animated.Value(0);
    ...
    onNextBtnClick = (context) => {
        ...
        console.log("context.state.index", context.state.index);

        this.swipper.scrollBy(context.state.index + 1, true);
    ...
    handleScroll = Animated.event([
        {nativeEvent: {contentOffset: {x: this.parallax}}},
    ], {
        listener: event => {
    ...
    handlePageScroll = (e: any) => {
        ...
        const contentOffset = offset * windowsWidth + (position * windowsWidth);
